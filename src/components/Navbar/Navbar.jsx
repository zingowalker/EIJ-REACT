                                    ...
                                    <div className="flex space-x-4 items-center">
                                        ...
                                        {/* <div onMouseLeave={() => setDrop(false)} className="relative">
                                            <Menu as="div" className="relative ml-3">
                                                <Menu.Button className="p-1 text-gray-400 hover:text-white"
                                                    onMouseOver={() => setDrop(true)}>
                                                    <span className="sr-only">Open user menu</span>
                                                    <p to="/" className="relative text-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium" aria-hidden="true">Destination
                                                    </p>
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 absolute top-3 left-24 ">
                                        ...
                                        <Menu as="div" className="relative ml-3">
                                            ...
                                            >
                                                ...
                                                >
                                                    <span className="sr-only">Open user menu</span>
                                                    <Link to="/destination" className="relative text-white hover:bg-gray-700 hover:text-white rounded-md px-2 py-2 text-sm font-medium" aria-hidden="true">Destination
                                                    </Link>
                                                    <svg
                        ...
                        <div className="space-y-1 px-2 pb-3 pt-2">
                            ...
                            <Menu as="div" className="relative ml-2">
                                <div>
                                    ...
                                    >
                                        <span className="sr-only">Open user menu</span>
                                        <span to="/" className="relative text-white hover:bg-gray-700 hover:text-white rounded-md px-0 py-2 text-base block font-medium" aria-hidden="true">Destination
                                        </span>
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="white"
