const LadakhBanner = () => {
    return (
        ...
        <div className="mx-auto py-12">
            {/* <div className="flex justify-center  md:space-y-0 md:space-x-6 lg:space-x-8"> */}
                ...
                <div className="flex justify-center  md:space-y-0 md:space-x-6 lg:space-x-8">
                    <img className="max-w-full h-auto" src="./images/indus-zanskar-river.jpg" alt="indus zanskar river confluence" />
                </div>
                {/* </div> */}
