...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_yree71c', 'template_e91a9va', form.current, 'WBOhbe88gCCaMVVhA')
            .then((result) => {
    ...
    return (
        <form ref={form} onSubmit={sendEmail} className="bg-white dark:bg-gray-900 space-y-8">
            <div className="py-8 lg:py-12 px-4 mx-auto max-w-screen-md">
                ...
                <button type="submit" className="w-full py-4 px-10 mt-4 text-sm font-semibold text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-blue-500 dark:hover:bg-blue-400 dark:focus:ring-blue-700">
                    Submit
                </button>
            </div>
        </form>
